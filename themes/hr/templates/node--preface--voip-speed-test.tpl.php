...
// Ookla speed test page original content. -------------------------------------------------------------------------------
  ...
  $path_to_custom_js = drupal_get_path('module', 'hr_pages') . '/js/';
  drupal_add_js($path_to_custom_js . 'hr_speedtest_page.js');
     ...
     <div class="share">
       <div class="main">
              ...
              <?php
                ...
                $url = 'http://cloudhostinghq.com' . $_SERVER['REQUEST_URI']; 
                echo hr_blocks_getSocialiteButtons($url, $share_title); 
