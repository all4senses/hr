 ...
 * 3. Read carefully, especially within hr_aqua_preprocess_html(), there
...
function hr_aqua_preprocess_html(&$vars) {
  // Load the media queries styles
  // Remember to rename these files to match the names used here - they are
  // in the CSS directory of your subtheme.
//  $media_queries_css = array(
//    'hr_aqua.responsive.style.css',
//    'hr_aqua.responsive.gpanels.css'
//  );
//  load_subtheme_media_queries($media_queries_css, 'hr_aqua');
...
//  );
//  load_subtheme_ie_styles($ie_files, 'hr_aqua');
...
function hr_aqua_process_html(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function hr_aqua_preprocess_page(&$vars) {
}

function hr_aqua_process_page(&$vars) {
}
// */
...
function hr_aqua_preprocess_node(&$vars) {
}

function hr_aqua_process_node(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function hr_aqua_preprocess_comment(&$vars) {
}

function hr_aqua_process_comment(&$vars) {
}
// */
 ...
 */
function hr_aqua_preprocess_block(&$vars) {
...
function hr_aqua_process_block(&$vars) {
}
// */
